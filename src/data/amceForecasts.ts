...
export const AMCE_PURCHASE_REQUESTS: PurchaseRequest[] = [
  {
    ...
    quantityPerUnit: 20,
    unitsRequired: 4,
    justification: "Requested for Parasitology bench specimen collection and transport workflow.",
    urgency: "High",
    currentStock: 0,
  ...
  },
  {
    ...
    itemName: "Amies swab (w/ or w/o charcoal)",
    quantityRequested: 4,
    quantityPerUnit: 20,
    unitsRequired: 4,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    urgency: "High",
    currentStock: 0,
    averageMonthlyUsage: 2,
    preferredManufacturer: "Copan Transystem™",
    alternateManufacturer: "Thermo Fisher Oxoid",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    currentStock: 0,
    averageMonthlyUsage: 2,
    preferredManufacturer: "Copan",
    alternateManufacturer: "Puritan",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Throat swab, break-shaft",
    quantityRequested: 4,
    quantityPerUnit: 20,
    unitsRequired: 4,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    ...
    currentStock: 0,
    averageMonthlyUsage: 2,
    preferredManufacturer: "Copan FLOQSwab®",
    alternateManufacturer: "Puritan Opti-Swab™",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    preferredManufacturer: "Copan UTM",
    alternateManufacturer: "Hardy Diagnostics VTM",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Sputum container 50 mL",
    quantityRequested: 4,
    quantityPerUnit: 20,
    unitsRequired: 4,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    ...
    currentStock: 0,
    averageMonthlyUsage: 2,
    preferredManufacturer: "Medline",
    alternateManufacturer: "Sarstedt",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Lumbar puncture (spinal) needle",
    quantityRequested: 2,
    quantityPerUnit: 20,
    unitsRequired: 2,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    ...
    preferredManufacturer: "BD Quincke",
    alternateManufacturer: "B. Braun Spinocan®",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Calibrated CSF collection tube",
    quantityRequested: 1,
    quantityPerUnit: 20,
    unitsRequired: 1,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    ...
    currentStock: 0,
    averageMonthlyUsage: 1,
    preferredManufacturer: "Sarstedt",
    alternateManufacturer: "Globe Scientific",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    ...
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Flocked swab + VTM (resp.)",
    quantityRequested: 1,
    quantityPerUnit: 20,
    unitsRequired: 1,
    justification: "Requested for General culture bench specimen collection and transport workflow.",
    ...
    currentStock: 0,
    averageMonthlyUsage: 1,
    preferredManufacturer: "Copan eSwab®",
    alternateManufacturer: "Puritan UniTranz-RT",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
  },
  {
    id: "PR-010",
    requestDate: "2026-05-15",
    requestingSection: "media-prep",
    requestedBy: "Abubakar",
    itemName: "DCA Agar (500 g dehydrated)",
    quantityRequested: 2,
    quantityPerUnit: 1,
    unitsRequired: 2,
    justification: "Requested for Media preparation bench media compounding workflow.",
    urgency: "High",
    currentStock: 0,
    averageMonthlyUsage: 1,
    preferredManufacturer: "MAST Group",
    alternateManufacturer: "Oxoid CM0033",
    approvalStatus: "Approved",
    approvedBy: "Procurement",
    procurementStatus: "Delivery pending",
    dateSupplied: null,
