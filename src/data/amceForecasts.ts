...
// Items requested via procurement that have NOT been received. They must not
// appear in the equipment / inventory registers — only here.
export const AMCE_PURCHASE_REQUESTS: PurchaseRequest[] = [
  {
    id: "PR-EQ-001",
    requestDate: today,
    requestingSection: "ipc",
    requestedBy: "Emediong",
    itemName: "Air sampler",
    quantityRequested: 1,
    justification: "Required for theatre / high-risk unit environmental air sampling. Not yet received.",
    urgency: "High",
    currentStock: 0,
  ...
  },
  {
    id: "PR-EQ-002",
    requestDate: today,
    requestingSection: "general-culture",
    requestedBy: "Juwairiya",
    itemName: "Anaerobic jar system / anaerobic workstation",
    quantityRequested: 1,
    justification: "Needed for routine anaerobic culture. Not yet received.",
    urgency: "High",
    currentStock: 0,
    averageMonthlyUsage: 0,
    supplierPreference: null,
  ...
  },
  {
    ...
    requestedBy: "Felicita",
    itemName: "Digital / probe thermometer",
    quantityRequested: 1,
    justification: "Cold chain / incubator / water bath temperature verification. Not yet received.",
    urgency: "Medium",
    currentStock: 0,
    averageMonthlyUsage: 0,
    supplierPreference: null,
  ...
  },
  {
    ...
    requestingSection: "ipc",
    requestedBy: "Emediong",
    itemName: "ATP luminometer",
    quantityRequested: 1,
    justification: "ATP cleaning verification monitoring. Not yet received.",
    urgency: "Medium",
    currentStock: 0,
    averageMonthlyUsage: 0,
    supplierPreference: null,
