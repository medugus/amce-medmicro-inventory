...
export const AMCE_USERS: AMCEUser[] = [
  ...
  { id: "u-george", name: "George", role: "Section Head", title: "Blood culture and general culture bench lead", sections: ["blood-culture", "general-culture"], active: true },
  { id: "u-chidi", name: "Chidi", role: "Section Head", title: "Urine culture and Molecular/GeneXpert bench lead", sections: ["urine-culture", "molecular"], active: true },
  ...
  { id: "u-echici", name: "Echici", role: "Section Head", title: "Parasitology bench lead", sections: ["parasitology"], active: true },
