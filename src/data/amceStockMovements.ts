...
export const AMCE_STOCK_MOVEMENTS: StockMovement[] = [
  ...
  { id: "mv-005", inventoryItemId: "inv-009", batchId: "b-005", movementType: "Issue", quantity: 3, fromSection: "stores", toSection: "general-culture", dateTime: addDays(-20), performedBy: "Felicita", authorisedBy: "Juwairiya", reason: "AST bench replenishment", referenceNumber: "ISS-2025-0190", notes: "" },
];
