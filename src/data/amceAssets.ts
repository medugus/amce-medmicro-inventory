...
const SEED: SeedDurable[] = [
  ...
  // Durables identified in equipment list:
  { slug: "settle-plate-rack", assetName: "Settle plate exposure rack/stand", assetCategory: "IPC durables", quantity: 0, laboratorySection: "ipc", notes: "Environmental surveillance durable." },
  { slug: "single-channel-pipettes", assetName: "Single-channel micropipettes", assetCategory: "Pipettes", quantity: 0, notes: "Track individually if calibrated." },
  { slug: "multichannel-pipettes", assetName: "Multichannel micropipettes", assetCategory: "Pipettes", quantity: 0, notes: "Track calibration due dates." },
  { slug: "bottle-top-dispenser", assetName: "Bottle-top dispenser", assetCategory: "Bench equipment accessories", quantity: 0, laboratorySection: "media-prep", notes: "Track calibration / verification if used quantitatively." },
  { slug: "electronic-pipette", assetName: "Electronic pipette", assetCategory: "Pipettes", quantity: 0, notes: "Track calibration." },
  { slug: "staining-rack", assetName: "Staining rack/system", assetCategory: "Staining ware", quantity: 0, laboratorySection: "gram-stain" },
  { slug: "staining-trough", assetName: "Staining trough/jar set", assetCategory: "Staining ware", quantity: 0, laboratorySection: "gram-stain" },
  { slug: "spill-kit-station", assetName: "Chemical spill kit station", assetCategory: "Safety durables", quantity: 0 },
  { slug: "weighing-boat-station", assetName: "Laboratory weighing boat / dispenser station", assetCategory: "Bench equipment accessories", quantity: 0, laboratorySection: "media-prep" },
  { slug: "freezer-rack-system", assetName: "Freezer rack system", assetCategory: "Freezer racks", quantity: 0, laboratorySection: "isolate-storage" },
  { slug: "freezer-boxes", assetName: "Freezer boxes", assetCategory: "Freezer boxes", quantity: 0, laboratorySection: "isolate-storage", notes: "Quantity-tracked." },
  { slug: "stainless-filtration-funnels", assetName: "Reusable stainless-steel filtration funnels", assetCategory: "Reusable funnels", quantity: 0, laboratorySection: "water" },
  { slug: "reusable-forceps", assetName: "Reusable forceps", assetCategory: "Bench equipment accessories", quantity: 0, laboratorySection: "water" },
  { slug: "culture-plate-racks", assetName: "Culture plate racks", assetCategory: "Racks", quantity: 0, laboratorySection: "general-culture" },
  { slug: "test-tube-racks", assetName: "Test-tube racks", assetCategory: "Racks", quantity: 0 },
  { slug: "slide-boxes", assetName: "Slide boxes", assetCategory: "Microscope accessories", quantity: 0, laboratorySection: "gram-stain" },
  { slug: "specimen-cool-box", assetName: "Specimen transport cool box", assetCategory: "General laboratory durables", quantity: 0, notes: "May need temperature checks." },
  { slug: "autoclave-waste-bins", assetName: "Autoclave waste bins / trolleys", assetCategory: "General laboratory durables", quantity: 0, laboratorySection: "media-prep" },
  { slug: "lab-trolley", assetName: "Laboratory trolley", assetCategory: "General laboratory durables", quantity: 0 },
];
