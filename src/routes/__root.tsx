  ...
  head: () => ({
    meta: [
      ...
      { title: "AMCE Medical Microbiology Lab Inventory" },
      {
        name: "description",
        content:
          "Inventory, supply status, batch tracking, acceptance testing and equipment management for AMCE Abuja, Department of Medical Microbiology and Immunology.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bcf0b153-0ebc-40b1-9015-4a7ea83f5fba/id-preview-05f4f8a0--7c6c1f81-c72f-4335-b819-b626b7990fc1.lovable.app-1777626952420.png",
      },
      {
        name: "twitter:image",
        content:
